    ...
    return (
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
                <h2 className="relative z-10 max-w-xl text-4xl font-medium lg:text-5xl">The Nexura ecosystem brings together our models.</h2>
                <div className="relative">
                    <div className="relative z-10 space-y-4 md:w-1/2">
                        <p>
                            Nexura is evolving to be more than just the models. <span className="font-medium">It supports an entire ecosystem</span> — from products innovate.
                        </p>
